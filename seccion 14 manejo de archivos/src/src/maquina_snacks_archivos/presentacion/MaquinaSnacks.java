...
public class MaquinaSnacks {
    ...
    public static void maquinaSnacks(){
        ...
        //creamos el objeto para obtener el sevicio de snack(lista)
        IServicioSnacks servicioSnacks = new ServicioSnacksLista();

        //creamos la lista de productos de tipo snack
        List<Snack> prductos = new ArrayList<>();
        System.out.println("*** Maquina de snacks ***");
        servicioSnacks.mostrarSnacks(); //mostrramos el inventario de snack disponibles
        while (!salir){
            try {
             var opcion = mostrarMenu(consola);
             salir = ejecutarOpciones(opcion,consola,prductos,servicioSnacks);
            }catch (Exception e){
